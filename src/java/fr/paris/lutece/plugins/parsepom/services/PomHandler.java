...
public class PomHandler extends DefaultHandler
{
     ...
     *            the text found
     * @param start
     *            the start position of text in the buffer
     * @param length
    ...
    public void endElement( String uri, String localName, String rawName )
    {
        ...
        if ( "dependency".equals( rawName ) )
        {
            ...
            if ( "id".equals( rawName ) && _nInsideDependency )
            {
                ...
                if ( "version".equals( rawName ) )
                {
                    ...
                    if ( "type".equals( rawName ) && _nInsideDependency )
                    {
                        _currentDependency.setType( getBodyText( ) );
                    }
                    else
                        if ( "groupId".equals( rawName ) && _nInsideDependency )
                        {
                            _currentDependency.setGroupId( getBodyText( ) );
                        }
                        else
                            if ( "artifactId".equals( rawName ) && _nInsideDependency )
                            {
